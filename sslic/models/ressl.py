...
class ReSSL(MomentumModel):
    ...
    def tiny_imagenet(cls, *args, **kwargs) -> MomentumModel:
        return super().tiny_imagenet(*args, dim=128, hidden_dim=2048, momentum=0.996, **kwargs)

    @classmethod
    def cifar10(cls, *args, **kwargs) -> MomentumModel:
        return super().cifar10(*args, dim=128, hidden_dim=2048, momentum=0.99, **kwargs)

    @classmethod
    def cifar100(cls, *args, **kwargs) -> MomentumModel:
        return super().cifar100(*args, dim=128, hidden_dim=2048, momentum=0.99, **kwargs)
